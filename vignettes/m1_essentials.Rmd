...
**kalimat ini dicetak tebal**
*kalimat ini dicetak miring*
...
```{r}
"Halo, nama saya adalah muhammad ramzi farhan" # isi dengan nama Anda
```
...
```{r}
(beragam <-list("Semangat belajar!", 77.6, 16L, TRUE))
beragam
typeof(beragam)
```
...
?iris # mambaca dokumentasi data
dim(iris) # mengecek dimensi data, baris dan kolom
...
tail(iris, 10) # melihat 10 baris terakhir
summary(iris) # melihat  kesimpulan data
iris[1, ] # mengambil 1 baris pertama dari semua kolom
iris[c(1, 6, 12),] #mengambil baris 1,6,12
iris[ ,2, drop = FALSE]
iris[2,2] #
